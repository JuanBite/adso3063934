...
<div class="flex bg-[#99a1af66] p-10 rounded-sm justify-center items-center flex-col">
    ...
    <div class="flex gap-2 flex flex-col md:flex-row">
        <ul class="list bg-[#99a1af99] mt-4 text-white text-center rounded-box shadow-md w-64">
            <li class="list-row">
                <span class="text-[#fff9] font-semibold">Name:</span> <span>{{ $adopt->user->fullname }}</span>
            </li>
            <li class="list-row">
                <span class="text-[#fff9] font-semibold">Document:</span> <span>{{ $adopt->user->document }}</span>
            </li>
            <li class="list-row">
                <span class="text-[#fff9] font-semibold">Birthdate:</span> <span>{{ $adopt->user->birthdate }}</span>
            </li>
            <li class="list-row">
        ...
        <ul class="list bg-[#99a1af99] mt-4 text-white text-center rounded-box shadow-md w-64">
            ...
            <li class="list-row">
                <span class="text-[#fff9] font-semibold">Age:</span> <span>{{ $adopt->pet->age }} Y/M</span>
            </li>
            <li class="list-row">
